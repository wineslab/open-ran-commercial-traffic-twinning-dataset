...
Dataset for the paper L. Bonati, R. Shirkhani, C. Fiandrino, S. Maxenti, S. D'Oro, M. Polese, T. Melodia, "Twinning Commercial Network Traces on Experimental Open RAN Platforms," in Proceedings of ACM WiNTECH, Washington, DC, USA, November 2024. [[pdf]](https://arxiv.org/pdf/2409.16217)
...
- The dataset has the following structure: `cluster_<#>/slicing_<#>/scheduling<#>`
...
- UE files: 
    ...
    - `mgen.csv`: Application-layer KPMs collected from the MGEN logs and converted to a `.csv` file using the `recv-to-csv.sh` script from the [mgen-tools](https://github.com/fg-networking/mgen-tools) repository.
